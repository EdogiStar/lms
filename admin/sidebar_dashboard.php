     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li>
                            <a href="payments.php"><i class="icon-chevron-right"></i><i class="icon-bar"></i>Payments</a>
                        </li>
                        <li>
                            <a href="contact.php"><i class="icon-chevron-right"></i><i class="icon-bar"></i>Contacts</a>
                        </li>
                    </ul>
                </div>