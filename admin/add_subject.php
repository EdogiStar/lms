		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Back</a>
										...
										mysqli_query($conn,"insert into subject (subject_code,subject_title,description,unit,semester, thumbnail) values('$subject_code','$title','$description','$unit','$semester', 'admin/uploads/thumbnails.jpg')")or die(mysqli_error());
