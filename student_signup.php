...
$query = mysqli_query($conn,"insert into student (username, password, firstname, lastname, class_id, email, status) values ('$username', '$password', '$firstname','$lastname', '$class_id', '$email', 'Registered')") or die(mysqli_error()); 
	echo 'true';
